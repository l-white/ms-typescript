...
function calculateInterestOnlyLoanPayment(principle: number, interestRate: number) {
...
function calculateConventionalLoanPayment(principle: number, interestRate: number, months: number) {
